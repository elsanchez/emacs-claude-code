<!-- ---
!-- Timestamp: 2025-05-19 08:56:38
!-- Author: ywatanabe
!-- File: /ssh:ywatanabe@sp:/home/ywatanabe/.dotfiles/.claude/to_claude/guidelines/IMPORTANT_guidelines_programming_python_MNGS_rules.md
!-- --- -->
...
- Installed via pip in development mode:
  ```bash
  pip install -e ~/proj/mngs_repo
  ```
...
mngs.io.save(obj, './relative/path.ext', symlink_from_cwd=True)   # ALWAYS specify symlink_from_cwd, Always start relative path from `./` 
```
...
└── scripts/                # Script files and outputs
    └── <category>/
        ...
        └── script_out/     # Output directory for this script
            ...
            ├── RUNNING     # Status files (managed by mngs)
            ├── FINISHED_SUCCESS
            └── FINISHED_FAILURE
```
